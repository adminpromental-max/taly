                            ...
                            <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                ...
                                <div class="row gx-20">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="price-checkbox d-flex gap-12 mb-4">
                                            <label for="checkbox7">{{ __('bundle_course') }}</label>
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_bundle_course]" type="checkbox" id="checkbox7"  value="1" {{ is_array($user->permissions) && in_array('can_edit_bundle_course', $user->permissions) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="price-checkbox d-flex gap-12 mb-4">
                                            ...
                                            <div class="setting-check">
                                                <input name="permissions[can_edit_quiz_&_assignment]" type="checkbox" id="checkbox3"  value="1" {{ is_array($user->permissions) && in_array('can_edit_quiz_&_assignment', $user->permissions) ? 'checked' : '' }}>
