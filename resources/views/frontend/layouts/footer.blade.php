                    ...
                    <div class="col-md-4">
                        <div class="widget">
                            ...
                            <a href="{{ url('/') }}" class="brand-logo main-logo m-r-25">
                                @php
                                    $src = setting('light_logo') && @is_file_exists(setting('light_logo')['original_image']) ? get_media(setting('light_logo')['original_image']) : static_asset('frontend/img/taly/taly-wordmark-white.png');
                                @endphp
