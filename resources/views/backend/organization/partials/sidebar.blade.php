    ...
    <div class="header-position">
        ...
        <nav class="side-nav">
            <ul>
                ...
                @endif
                @if(hasPermission('manage_subscription') && addon_is_activated('saas_subscription'))
                    <li class="{{ menuActivation(['instructor/my-subscription', 'instructor/packages'], 'active') }}">
