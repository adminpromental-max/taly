...
class CourseDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('featured', function ($course) {
                return view('backend.admin.course.is_featured', compact('course'));
            })
    ...
    public function query(): QueryBuilder
    {
        ...
        return Course::with('category.language')->withCount('enrolls')->where('course_type', '!=', 'bundle')->when($id, function ($query) use ($id) {
