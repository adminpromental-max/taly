                                ...
                                <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                    ...
                                    <div class="row gx-20">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="price-checkbox d-flex gap-12 mb-4">
                                                <label for="checkbox10">{{ __('manage_subscription') }}</label>
                                                <div class="setting-check">
                                                    <input name="permissions[manage_subscription]" type="checkbox"
                                                        id="checkbox10"
                                                        {{is_array(@$user->permissions) && in_array('manage_subscription', $user->permissions) ? 'checked' : '' }}
                                                        value="1">
