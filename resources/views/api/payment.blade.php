        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="payment-list simplebar">
                    ...
                    @endif
                    @if(setting('is_tap_activated') == 1 && setting('tap_secret_key'))
                        <li>
                            <div class="input-checkbox">
                                <input type="radio" value="tap" id="tap" name="payment">
                                <label for="tap">
                    ...
                    @endif
                    @if(setting('is_esewa_activated') == 1 && setting('esewa_secret_key'))
                        <li>
                            <div class="input-checkbox">
                                <input type="radio" value="esewa" id="esewa" name="payment">
                                <label for="esewa">
                                    <img src="{{ static_asset('images/payment-icon/esewa.png') }}" alt="esewa"
                                         class="img-fluid">
                                </label>
                            </div>
                        </li>
                ...
                <div class="summary-position">
                    <div class="order-summary">
                        ...
                        <div class="sg-card">
                            <ul>
                                <li>
                                    ...
                                    <span
                                        class="price">{{ get_price($user_carts->sum('sub_total'),$currency_code) }}</span>
                                </li>
                                <li>
                                ...
                                @if(setting('coupon_system'))
                                    <li>
                                        ...
                                        <span
                                            class="price">{{ get_price($coupons->sum('coupon_discount'),$currency_code) }}</span>
                                    </li>
                                @endif
                            </ul>
                            <div class="order-total">
                                <p>
                                    ...
                                    <span
                                        class="price">{{ get_price($user_carts->sum('total_amount')  - $total_discount,$currency_code) }}</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="div_btns d-none">
                            ...
                            @endif
                            @if(setting('is_esewa_activated'))
                                <a href="{{ route('esewa.redirect',['trx_id' => $trx_id,'payment_type' => 'esewa','payment_mode' => 'api','token' => $token]) }}"
                                   class="submit-btn d-block text-center payment_btns esewa_btn">{{ __('proceed') }}</a>
                            @endif
                            @if(setting('is_tap_activated'))
                                <a href="{{ route('tap.redirect',['trx_id' => $trx_id,'payment_type' => 'tap','payment_mode' => 'api','token' => $token]) }}"
                                   class="submit-btn d-block text-center payment_btns tap_btn">{{ __('pay_now') }}</a>
                            @endif
                            @if(setting('is_uddokta_pay_activated'))
