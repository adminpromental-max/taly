...
class ProfileController extends Controller
{
    ...
    public function myProfile()
    {
        try {
            ...
            $purchased_bundle = $this->course->activeCourses([
                'my_course' => 1,
                'bundle'    => 1,
                'user_id'   => auth()->id(),
            ...
            $data             = [
                ...
                'purchased_bundle' => $purchased_bundle->total(),
                'purchased_book'   => 0,
    ...
    public function purchaseBundleCourses(Request $request): View|Factory|JsonResponse|RedirectResponse|Application
    {
        try {
            $courses = $this->course->activeCourses([
                'my_course' => 1,
            ...
            return view('frontend.profile.bundle', $data);
        } catch (Exception $e) {
            if (\request()->ajax()) {
                return response()->json([
                    'error' => $e->getMessage(),
    ...
    public function bundleCourses(Request $request, $slug): View|Factory|JsonResponse|RedirectResponse|Application
    {
        try {
            $bundle  = $this->course->findBySlug($slug);
            ...
            return view('frontend.profile.purchase_bundle', $data);
        } catch (Exception $e) {
            if (\request()->ajax()) {
                return response()->json([
                    'error' => $e->getMessage(),
