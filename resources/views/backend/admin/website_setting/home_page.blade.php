...
@section('content')
                ...
                <div class="col-xxl-9 col-xl-7 col-md-12">
                    ...
                    <div class="homepage-content" id="homepageContent">
                        ...
                        @foreach($sections as $key=> $section)
                            ...
                            @if($section->section == 'bundle_course')
                                <input type="hidden" name="ids[]" value="{{ $section->id }}">
                                <div class="accordion-item" data-type="bundle_course" id="bundle_course">
                                    <h2 class="accordion-header" id="bundleCourses">
                                        <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#bundle_course_section_{{$i}}" aria-expanded="true"
                                                aria-controls="bundleCourseCollapse">
                                            <img src="{{ static_asset('admin/img/icons/maximize.svg')}}" alt="maximize">
                                            <span>{{ __('bundle_courses') }}</span>
                                        </button>
                                        <a href="javascript:void(0)"
                                           data-url="{{ route('delete.home.section',$section->id) }}"
                                           class="delete-icon delete_section"><i class="las la-trash-alt"></i></a>
                                    </h2>
                                    <div id="bundle_course_section_{{$i}}" class="accordion-collapse collapse"
                                         aria-labelledby="bundleCourse"
                                         data-bs-parent="#homepageContent">
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="text" class="form-control rounded-2"
                                                               data-type="title"
                                                               value="{{ arrayCheck('title',$section->contents) ? $section->contents['title'] : '' }}"
                                                               name="builder[bundle_course_{{$i}}][title]"
                                                               id="courseTitle" placeholder="{{ __('enter_title') }}">
                                                    </div>
                                                </div>
                                                <!-- End Section Title -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="">
                                                        <label for="courseSubtitle"
                                                               class="form-label">{{ __('subtitle') }}</label>
                                                        <textarea name="builder[bundle_course_{{$i}}][sub_title]"
                                                                  class="form-control h-80" data-type="sub_title"
                                                                  id="courseSubtitle"
                                                                  placeholder="{{ __('enter_sub_title') }}">{{ arrayCheck('sub_title',$section->contents) ? $section->contents['sub_title'] : '' }}</textarea>
                                                    </div>
                    ...
                    <div class="fixedSide">
                        ...
                        <div class="bg-white redious-border p-20 px-xl-3 py-xl-20 simplebar">
                            <div class="builder-content" id="builderContent">
                                ...
                                <div class="builder" data-target_id="bundle_course" data-name="bundle_course"
                                     data-var_type="">
                                    <div class="icon">
                                        <img src="{{ static_asset('admin/img/icons/home-icon/gift-box.svg')}}"
                                             alt="Bundle Course">
                                    </div>
                                    <h6 class="title">{{ __('bundle_course') }}</h6>
                                </div>
                                <!-- End Builder -->
    ...
    <div class="modal">
        <div class="accordion" id="homepageContent">
            ...
            <div class="accordion-item" data-type="bundle_course" id="bundle_course">
                <h2 class="accordion-header" id="bundleCourse">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            data-bs-target="#bundleCourseCollapse" aria-expanded="true" aria-controls="bundleCourseCollapse">
                        <img src="{{ static_asset('admin/img/icons/maximize.svg')}}" alt="maximize">
                        <span>{{ __('bundle_course') }}</span>
                    </button>
                    <a href="javascript:void(0)" class="delete-icon"><i class="las la-trash-alt"></i></a>
                </h2>
                <div id="bundleCourseCollapse" class="accordion-collapse collapse show" aria-labelledby="bundleCourse"
                     data-bs-parent="#homepageContent">
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="courseTitle" class="form-label">{{ __('title') }}</label>
                                    <input type="text" class="form-control rounded-2" data-type="title"
                                           name="builder[bundle_course]" id="courseTitle"
                                           placeholder="{{ __('enter_title') }}">
                                </div>
                            </div>
                            <!-- End Section Title -->
                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    <label for="courseSubtitle" class="form-label">{{ __('subtitle') }}</label>
                                    <textarea name="builder[bundle_course]" class="form-control h-80"
                                              data-type="sub_title" id="courseSubtitle"
                                              placeholder="{{ __('enter_sub_title') }}"></textarea>
                                </div>
                            </div>
