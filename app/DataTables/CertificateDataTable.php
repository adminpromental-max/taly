    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($course) {
                ...
                $instructorIds = is_array($course->instructor_ids) ? $course->instructor_ids : explode(',', $course->instructor_ids);
                $instructors   = ! empty($instructorIds) ? User::whereIn('id', $instructorIds)->get() : collect();
