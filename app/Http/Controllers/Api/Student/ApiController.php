...
class ApiController extends Controller
{
    ...
    {
        try {
            $home_sections = HomeScreen::where('type', 'home_page')->orderBy('position')->get();
            $results[]     = [
            ...
            foreach ($home_sections as $home_section) {
                ...
                }if ($home_section->section == 'bundle_course') {
                    $results[] = [
                        'section_type'   => 'bundle_course',
                        'bundle_courses' => CourseResource::collection($courseRepository->activeCourses([
                            'paginate' => 10,
                            'bundle'   => 1,
                        ])),
                    ];
