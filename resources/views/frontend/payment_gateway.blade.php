                    ...
                    <div class="payment-gateway">
                        ...
                        <div class="row payment-methods-list">
                            ...
                            @if(setting('is_tap_activated'))
                                <div class="col-lg-3 col-md-3 col-4">
                                    <div class="payment-methods-item">
                                        <input type="radio" name="payment_type" value="tap" id="tap">
                                        <label for="tap">
                                            <img src="{{ static_asset('images/payment-icon/tap.svg') }}"
                                                 alt="tap">
                                        </label>
                                    </div>
                                </div>
                            ...
                            @if(setting('is_esewa_activated'))
                                <div class="col-lg-3 col-md-3 col-4">
                                    <div class="payment-methods-item">
                                        <input type="radio" name="payment_type" value="esewa" id="esewa">
                                        <label for="esewa">
                                            <img src="{{ static_asset('images/payment-icon/esewa.png') }}"
                                                 alt="esewa">
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="payment-methods-item">
                                        ...
                                        <label for="uddokta_pay">
                                            <img style="width: 200px"
                                                 src="{{ static_asset('images\payment-icon\uddokta_pay.svg') }}"
                                                 alt="uddokta_pay">
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="book-text-content">
                                            ...
                                            <div class="quantity-price-wrapper">
                                                <span class="quantity">1 ×</span>
                                                <span
                                                    class="price">{{ get_price($course->price, userCurrency()) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="cart-product-calculation m-t-sm-15">
                            ...
                            <div>
                                ...
                                <div class="div_btns d-none">
                                    ...
                                    @endif
                                    @if(setting('is_esewa_activated'))
                                        <a href="{{ route('esewa.redirect',['trx_id' => $trx_id,'payment_type' => 'esewa']) }}"
                                           class="template-btn d-block text-center payment_btns esewa_btn">{{ __('pay_now') }}</a>
                                    @endif
                                    @if(setting('is_sslcommerz_activated'))
                                    ...
                                    @endif
                                    @if(setting('is_tap_activated'))
                                        <a href="{{ route('tap.redirect',['trx_id' => $trx_id,'payment_type' => 'tap']) }}"
                                           class="template-btn d-block text-center payment_btns tap_btn">{{ __('pay_now') }}</a>
                                    @endif
                                    @if(setting('is_mollie_activated'))
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">{{ __('pay_with_offline') }} - <span
                            id="method_title"></span></h5>
                ...
                <form action="{{ route('complete.order') }}" method="POST" class="ajax_form">@csrf
                    ...
                    <div class="modal-footer">
                        <button type="button" class="template-btn btn-secondary"
