            ...
            <div class="header-inner">
                <div class="header-left">
                    <div class="brand-logo">
                        ...
                        @else
                            @php
                                $talyLogo = static_asset('frontend/img/taly/taly-wordmark.png');
                                $darkLogo = setting('dark_logo') && @is_file_exists(setting('dark_logo')['original_image'])
                                    ? get_media(setting('dark_logo')['original_image'])
                                    : $talyLogo;
                            @endphp
                            <a href="{{ route('home') }}" class="main-logo">
                                <img src="{{ $darkLogo }}" alt="Taly">
                            </a>
                            <a href="{{ route('home') }}" class="sticky-logo">
                                <img src="{{ $darkLogo }}" alt="Taly">
                            </a>
