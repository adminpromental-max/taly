    ...
    <div class="header-position">
        ...
        <nav class="side-nav">
            <ul>
                ...
                @endif
                @if(hasPermission('saas_packages.index') && addon_is_activated('saas_subscription'))
                    <li class="{{ menuActivation(['admin/saas-packages', 'admin/saas-packages/*', 'admin/saas-packages/create', 'admin/subscription-history','admin/subscription-create'], 'active') }}">
                        <a href="#managePackages" class="dropdown-icon" data-bs-toggle="collapse" role="button"
                           aria-expanded="{{ menuActivation(['admin/saas-packages', 'admin/saas-packages/*', 'admin/saas-packages/create', 'admin/subscription-history','admin/subscription-create'], 'true', 'false') }}"
                           aria-controls="managePackages">
                            <i class="las la-money-bill-wave"></i>
                            <span>{{ __('saas_packages') }}</span>
                        </a>
                        <ul class="sub-menu collapse {{ menuActivation(['admin/saas-packages', 'admin/saas-packages/*', 'admin/saas-packages/create', 'admin/subscription-history','admin/subscription-create'], 'show') }}"
                            id="managePackages">

                            @if(hasPermission('saas_packages.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/saas-packages', 'admin/saas-packages/*', 'admin/saas-packages/create'], 'active') }}"
                                       href="{{ route('saas-packages.index') }}">{{ __('packages') }}</a>
                                </li>
                            @endif
                            @if(hasPermission('subscription.index'))
                                <li>
                                    <a class="{{ menuActivation(['admin/subscription-history','admin/subscription-create'], 'active') }}"
                                       href="{{ route('subscription.history') }}">{{ __('purchase_history') }}</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                ...
                @endif
                @if(hasPermission('bundle_course.index') && addon_is_activated('bundle_course'))
                    <li
                        class="{{ menuActivation(['admin/bundle/course','admin/bundle/create','admin/bundle/edit/*'], 'active') }}">
                        <a href="{{ route('bundle.course') }}">
