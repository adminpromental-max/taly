...
Route::group(['prefix' => localeRoutePrefix()], function () {
    ...
    Route::group(['middleware' => 'studentCheck'], function () {
        ...
        Route::group(['as' => 'course.'], function () {
            ...
            Route::get('purchase-bundle-courses', [ProfileController::class, 'purchaseBundleCourses'])->name('bundle.purchase');
        ...
        Route::get('my-course-course/{slug}', [CourseController::class, 'myBundleCourse'])->name('my-bundle.course');
        Route::get('purchase-bundle/{slug}', [ProfileController::class, 'bundleCourses'])->name('purchase.bundle');
    ...
    //dynamic page route
    Route::get('page/{link}', [FrontendController::class, 'page'])->name('page.show');
...
Route::get('google/callback', function () {
    ...
    if (request()->has('code')) {
        ...
        file_put_contents(config('google-calendar.auth_profiles.oauth.token_json'), json_encode($token));
        Toastr::success('Google Calendar connected!');
