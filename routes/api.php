...
Route::middleware(['CheckApiKey'])->group(function () {
    ...
    Route::prefix('user')->middleware('jwt.verify')->group(function () {
        ...
        Route::get('my-bundle', [CourseController::class, 'purchaseBundle']);
        Route::get('bundle-courses/{slug}', [CourseController::class, 'bundleCourses']);
        Route::get('my-bundle-courses/{slug}', [CourseController::class, 'myBundleCourse']);
